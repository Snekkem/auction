...
import {Input, renderDateTimePicker} from "../formsControls/formsControl";
    ...
    return (
        <div>
            <form onSubmit={handleSubmit}>
                ...
                <small className={'text-dark'}>Min extension time</small>
                <div className={"form-group row no-gutters justify-content-center"}>
                    ...
                    <Field name="min_extension_hours" type={'number'} className={'mx-5'} valueField={'0'}
                           ...
                           component={Input} defaultValue={['0']}
                    />
                    <Field validate={[required, minValue1, maxValue60]} name="min_extension_minutes" type={'number'}
